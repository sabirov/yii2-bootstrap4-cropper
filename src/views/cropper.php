...
switch ($jsOptions['pos']) {
    case View::POS_END:
        \sabirov\bootstrap4_cropper\CropperAsset::register($this);
        break;
    case View::POS_BEGIN:
        \sabirov\bootstrap4_cropper\CropperBeginAsset::register($this);
        break;
    case View::POS_HEAD:
        \sabirov\bootstrap4_cropper\CropperHeadAsset::register($this);
        break;
    case View::POS_LOAD:
        \sabirov\bootstrap4_cropper\CropperLoadAsset::register($this);
        break;
    case View::POS_READY:
        \sabirov\bootstrap4_cropper\CropperReadyAsset::register($this);
        break;
    default:
        \sabirov\bootstrap4_cropper\CropperAsset::register($this);
}
